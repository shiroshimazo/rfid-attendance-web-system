...
export async function beginEmailLogin(input: { email: string; password: string }) {
  return auditActivity("begin_email_login", "authentication", async () => {
...
export async function verifyEmailLogin(code: string) {
  return auditActivity("verify_email_login", "authentication", async () => {
...
export async function cancelEmailLogin() {
  return auditActivity("cancel_email_login", "authentication", async () => {
    const jar = await cookies()
    const token = jar.get(cookieName)?.value
    jar.delete(cookieName)
    if (token) {
...
export async function resendEmailLogin() {
  return auditActivity("resend_email_login", "authentication", async () => {
    try {
