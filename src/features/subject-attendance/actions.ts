...
export async function confirmSubjectAction(input: unknown) {
  return auditActivity("confirm_subject", "subject_attendance", async () => {
...
export async function createSubjectScheduleAction(input: unknown) {
  return auditActivity("create_subject_schedule", "subject_attendance", async () => {
...
export async function retireSubjectScheduleAction(input: unknown) {
  return auditActivity("retire_subject_schedule", "subject_attendance", async () => {
    await requireRole("admin")
...
export async function saveSubjectEnrollmentAction(input: unknown) {
  return auditActivity("save_subject_enrollment", "subject_attendance", async () => {
    await requireRole("admin")
...
export async function editSubjectScheduleAction(input: unknown) {
  return auditActivity("edit_subject_schedule", "subject_attendance", async () => {
    await requireRole("admin")
