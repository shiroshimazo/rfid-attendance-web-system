...
P02 create/edit actions validate active programs and subject membership before Auth account
creation. Every assignment requires an explicit active catalog year, section, and campus.
