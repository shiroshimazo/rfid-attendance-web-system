...
export async function createTeacherAction(
  ...
  return auditActivity("create_teacher", "teachers", async () => {
...
export async function updateTeacherAction(
  ...
  return auditActivity("update_teacher", "teachers", async () => {
    await requireRole("admin")
...
export async function setTeacherStatusAction(
  ...
  return auditActivity("set_teacher_status", "teachers", async () => {
    await requireRole("admin")
