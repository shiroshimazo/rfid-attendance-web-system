...
import type { TeacherSectionBreakdown } from "@/features/reports/teacher-panel"
...
function compareRows(
  a: TeacherSectionBreakdown,
  b: TeacherSectionBreakdown,
  column: SortColumn,
  direction: "asc" | "desc"
) {
  ...
  return (
    <Card data-print="block">
      <CardHeader>
        ...
        <CardDescription>
          Assigned-section totals and attendance rate for {rangeLabel}.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent>
        {visible.length === 0 ? (
          <EmptyState
            ...
            description="Assigned sections appear here once students are enrolled."
          />
        ) : (
