...
- `courses` for subjects such as IPT, ITE, and MS101, archived rather than deleted
- `academic_sections` for the year level, section, and campus groupings that feed pickers
