...
- [ ] **UX03:** Check Present, Late, Excused, explicit Absent, no record before class, and an unscheduled day. Dashboard and history agree on recorded status. A provisional no-tap state does not silently change the stored record or KPI policy.
...
| UX03 | W07–W09, W20 | Use Asia/Manila consistently. Agree when absence becomes final and how unscheduled days and Excused records behave before changing aggregate calculations. |
